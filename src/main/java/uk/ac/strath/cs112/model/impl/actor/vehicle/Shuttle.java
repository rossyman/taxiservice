...
/**
 * A shuttle is able to carry multiple passengers. This implementation is non-functional.
 *
...
public class Shuttle extends Vehicle {
   ...
   *
   * @param company The taxi taxiCompany. Must not be null.
   * @param location The vehicle's starting point. Must not be null.
   * @throws NullPointerException If taxiCompany or location is null.
   */
  ...
  /**
   * Offload a passenger whose destination is the current location.
   */
